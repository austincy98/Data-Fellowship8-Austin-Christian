...
PROJECT_ID = os.environ.get("balmy-hologram-370008")
BUCKET = os.environ.get("GCP_GCS_BUCKET")
# PROJECT_ID = "fellowship-7"
# BUCKET = "fellowship-7"

dataset_file = "Nation_populaltion.json "
...
def format_to_csv(src_file):
    ...
    df.to_csv(src_file.replace('.json', '.csv'))
...
def upload_to_gcs(bucket, object_name, local_file):
    ...
    object_name = "balmy-hologram-370008"
